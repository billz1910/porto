...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/billz1910",
      };
  ...
  const projectUrl = `https://porto-billz.vercel.app/project/${toSlug(project.Title)}`;

  return (
    <>
      <Helmet>
        <title>{project.Title} — Muhammad Nabil Sutisna</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh Muhammad Nabil Sutisna — Cyber Security Analyst.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Muhammad Nabil Sutisna`}
        />
        <meta
